;(function (window) {
    ...
    let texts = ['TAP DIMANA AJA YA :)','COBA DIMIRINGIN DEH HP NYA', 'UDAH??', 'HMMM', 'KALIAN TAU GA HARI INI HARI APA', 'IYAPP BETULL', 'HARI PEMILU :] ', 'WKWKWKWK GGGG', 'HARI INI TU HARI DIMANA', 'ORANG ORANG DAPET HADIAH KAN YAA?', 'KAMU UDAH DPT BLM NIII', 'SSST GA USAH NGOMONG', 'AKU TAU KAMU BLM DPT APA APA ', 'KARENA', 'KALIAN JOMBLO LAH APALAGI CB', 'WKWKWKKWK', 'TAPI', 'KARENA ITU AKU MAU', 'NGASIH SESUATU ', 'NGASIH APA TEBAK', 'YG PASTI BKN BANSOS SIH', 'AKU BLM NYALEG SOALNYA', 'AKU CUMA MAU NGASIH TAU', 'KALO KALIAN TUU HEBATT TAUU', 'UDAH BERHASIL SURVIVE SAMPE SEJAUH INIII', 'JADI SEMANGAT YAA DI SMT 2 NYAA! YAA!!', 'DAN', 'SEMANGAT JUGA BUAT PRD NYAA!!!', 'SEMOGA KITA SEMUA DAPAT HASIL TERBAIKK <3','Ttd : Jean']
